...
int main(int argc, char *argv[]) {
    ...
    NF_LoadSpriteGfx("sprites/basic-enemy", Sprites::BASIC_ENEMY_GFX_ID, 16,
                     16);

    NF_LoadSpritePal("sprites/spritesheet-allies", Sprites::ALLIES_PALETTE_ID);
    NF_LoadSpritePal("sprites/spritesheet-enemies",
                     Sprites::ENEMIES_PALETTE_ID);
    ...
    NF_VramSpriteGfx(Screen::BOT, Sprites::S_ACE_GFX_ID, Sprites::S_ACE_GFX_ID,
                     false);
    NF_VramSpritePal(Screen::TOP, Sprites::ALLIES_PALETTE_ID,
                     Sprites::ALLIES_PALETTE_ID);
    NF_VramSpritePal(Screen::BOT, Sprites::ALLIES_PALETTE_ID,
                     Sprites::ALLIES_PALETTE_ID);
    // Bullet
    ...
    NF_VramSpriteGfx(Screen::BOT, Sprites::BULLET_GFX_ID,
                     Sprites::BULLET_GFX_ID, false);
    // Enemies
    NF_VramSpritePal(Screen::TOP, Sprites::ENEMIES_PALETTE_ID,
                     Sprites::ENEMIES_PALETTE_ID);
    NF_VramSpritePal(Screen::BOT, Sprites::ENEMIES_PALETTE_ID,
                     Sprites::ENEMIES_PALETTE_ID);
    NF_VramSpriteGfx(Screen::TOP, Sprites::BASIC_ENEMY_GFX_ID,
